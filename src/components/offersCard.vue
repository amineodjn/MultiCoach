  ...
  >
    ...
    >
      <button
        @click="emitFavorite"
        type="button"
        class="relative inline-flex items-center justify-center p-0.5 m-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br border border-indigo-600 dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800"
      >
        <span
      ...
      <div class="ml-3 hover:bg-gray-100 rounded-md" v-if="coachAccess" @click="emitDeleteOffer">
        <svg
