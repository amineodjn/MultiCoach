  ...
  >
    <div class="flex flex-col sm:-mx-4 sm:flex-row">
      ...
      <div class="sm:mx-4 sm:mt-0">
        ...
        <div class="flex flex-col lg:flex-row mt-2">
          <a
            class="flex text-gray-600 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300"
            aria-label="gym"
          >
            <svg
              class="w-6 h-6"
    ...
    <div class="flex justify-end items-center lg:justify-center">
      ...
      <button
        ...
        v-if="coachAccess"
        @click="$emit('editClass', trainingClass)"
        tabindex="0"
        aria-label="Edit class"
        @keydown.enter="$emit('editClass', trainingClass)"
      >
        <svg
...
const emit = defineEmits(["book", "deleteClass", "editClass"]);
