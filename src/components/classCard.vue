      ...
      <div class="bg-white border shadow-sm rounded-xl dark:bg-neutral-900 dark:border-neutral-700 dark:shadow-neutral-700/70">
        ...
        <div class="p-4 md:p-3">
          ...
          <p class="mt-1 text-gray-500 dark:text-neutral-400">
            {{ trainingClass.classDescription }}
          </p>
          <div class="flex-col mt-2">
            <a class="flex text-gray-600 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300" aria-label="Github">
            ...
            <a class="flex text-gray-600 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300" aria-label="location">
              <svg class="w-6 h-6 text-indigo-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
          ...
          <div class="text-right">
            <button type="button" @click="book" class="mt-2 py-2 px-3 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-gray-200 text-gray-500 hover:border-indigo-600 hover:text-indigo-600 disabled:opacity-50 disabled:pointer-events-none dark:border-neutral-700 dark:text-neutral-400 dark:hover:text-indigo-500 dark:hover:border-indigo-600">
              Reserve
            </button>
          </div>
        </div>
