    ...
    <form @submit.prevent class="mt-6 m-2 md:m-6">
      <div class="flex">
        ...
        <div
          ...
          style="position: absolute; top: 75px; margin: 0px"
        >
          <ul
          ...
          >
            <li v-for="city in cities" :key="city">
              <button
                ...
                "
                type="button"
                class="inline-flex w-full px-4 py-2 text-sm text-gray-700 hover:text-indigo-700 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-600 dark:hover:text-white"
                role="menuitem"
              >
        ...
        <div class="relative w-full">
          ...
          <span
            v-if="selectedCity != ''"
            class="absolute top-3 left-2 bg-indigo-100 text-indigo-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-full dark:bg-gray-700 dark:text-gray-300"
            >{{ selectedCity }}
            <button
              @click="removeCity"
              type="button"
          ...
          <button
            type="submit"
            class="absolute top-0 end-0 h-full p-2.5 text-sm font-medium text-white bg-indigo-700 rounded-e-lg border border-indigo-700 hover:bg-indigo-800 focus:ring-4 focus:outline-none focus:ring-indigo-300 dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-indigo-800"
          >
            <svg
              class="w-4 h-4"
              aria-hidden="true"
