            ...
            <div class="w-full pb-0 p-5 bg-white border border-gray-200 rounded-lg shadow dark:bg-neutral-800 dark:border-neutral-700 ">
              ...
              <div class="pt-0.5 pb-0.5 whitespace-nowrap overflow-y-hidden overflow-x-auto gap-2 justify-between items-center flex-row flex mt-7 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500">
                <nav class="flex space-x-6">
                  ...
                  <router-link class="py-4 px-1 inline-flex items-center gap-2 border-b-2 border-indigo-500  text-sm font-medium whitespace-nowrap text-indigo-600 focus:outline-none focus:text-indigo-800 dark:text-indigo-500" to="/connections">
                    <svg class="flex-shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                  ...
                  <router-link class="py-4 px-1 inline-flex items-center gap-2 border-b-2 border-transparent  text-sm whitespace-nowrap text-gray-500  hover:text-indigo-600 focus:outline-none focus:text-indigo-600 dark:text-neutral-500 dark:hover:text-indigo-500" to="/editProfile">
                    <svg class="flex-shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
