<template>
  <div class="flex flex-col border-gray-300 mt-5 rounded-lg bg-white shadow-sm p-4">
    <div class="flex justify-between flex-col md:flex-row items-start md:items-center py-4 px-5">
      ...
      <div class="flex items-center md:justify-end space-x-2">
        ...
        <button @click="addClass" type="button" class="px-3 py-2 text-sm font-medium text-center inline-flex items-center text-white bg-indigo-700 rounded-lg hover:bg-indigo-800 focus:ring-4 focus:outline-none focus:ring-indigo-300 dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-indigo-800">
      ...
      <div class="bg-white p-6 rounded-lg shadow-lg">
        <div class="flex justify-between items-center">
          ...
          <button 
                ...
                @click="showForm = false" data-modal-toggle="classesModal">
