<template>
  <div class="flex flex-col border-gray-300 mt-5 rounded-lg bg-white border shadow-sm p-4">
    ...
    <div class="flex flex-col px-5 border-gray-300 mt-5 divide-y rounded-lg bg-white shadow-sm">
      <offersCard 
