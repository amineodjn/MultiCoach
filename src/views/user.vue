  ...
  <main id="content" class="content-container">
    <div class="mx-auto">
      <div class="md:pt-5 sm:pt-0 sm:pb-0 sm:p-5 p-2">
        ...
        <div
          class="space-y-5 mt-5 lg:shadow-sm lg:p-5 bg-white lg:border lg:border-gray-200 lg:rounded-lg flex flex-col"
        >
          <div class="xl:flex divide-x space-x-20">
            <!--sidebar-->
            <div
              class="xl:p-0 xl:block xl:z-0 xl:relative xl:bottom-0 transition duration-300 p-5 bg-white border-gray-200 overflow-y-auto hidden fixed"
            >
              <div
                class="dark:divide-neutral-700 xl:pe-4 mt-3 space-y-5 divide-y"
              >
                <div class="first:pt-0 pt-4">
                  <h2 class="text-sm leading-5 font-semibold text-gray-800">
                    About
                  </h2>
                  <!--list-->
                  <ul class="mt-3 space-y-2">
                    <li>
                      <div
                        class="text-gray-800 text-sm leading-5 gap-x-3 inline-flex items-center dark:text-neutral-200"
                      >
                        <svg
                ...
                <div class="first:pt-0 pt-4">
                  <h2
                    class="text-sm leading-5 mb-3 font-semibold text-gray-800"
                  >
                    Connections
                  </h2>
                  <ul class="space-y-2">
                    <li
                      v-if="!user.favoriteCoaches"
                      class="text-gray-800 text-sm leading-5 gap-x-3 inline-flex items-center dark:text-neutral-200"
                    >
                    ...
                    <li
                      v-else
                      v-for="connection in userConnection"
                      :key="connection.uid"
                    >
                      <div class="flex items-center gap-x-3">
                        <img
                          v-if="connection.profilePicture"
                          class="flex flex-shrink-0 justify-center items-center rounded-full w-9 h-9"
                          :src="connection.profilePicture"
                          alt="Connection image"
                        />
                        <span
                          v-else
                          class="flex flex-shrink-0 justify-center items-center w-9 h-9 bg-white text-gray-700 text-opacity-100 dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-300 border border-gray-200 border-opacity-100 rounded-full uppercase font-medium text-xs leading-4"
                        >
                          {{
                            getInitials(
                        ...
                        <div class="flex-grow">
                          <router-link
                            :to="`/profile/${connection.uid}`"
                            class="block text-gray-800 text-opacity-100 font-medium text-sm leading-5 dark:text-neutral-200 hover:text-indigo-500 focus:text-indigo-500 dark:hover:text-indigo-500 dark:focus:text-indigo-500"
                            href=""
                          >
                            {{
                ...
                <div class="first:pt-0 pt-4">
                  ...
                  <ul class="space-y-2">
                    ...
                    <li>
                      <div
                        v-for="(value, key) in user.schedule"
                        :key="value.index"
                        class="text-gray-800 text-sm leading-5 flex justify-between items-center dark:text-neutral-200"
                      >
